...
class AttendanceSettingsController extends Controller
{
    public function edit()
    {
        $settings = [
            ...
            'require_network_match' => AttendanceConfig::get('require_network_match', true),
    ...
    public function update(Request $request)
    {
        $data = $request->validate([
            ...
            'require_network_match' => ['nullable', 'boolean'],
        ...
        AttendanceSetting::set('require_network_match', $request->boolean('require_network_match'));
